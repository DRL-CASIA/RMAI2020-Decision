...
#ifndef PROTOBUF_INCLUDED_dynamic_5fobstacle_5flayer_5fsetting_2eproto
#define PROTOBUF_INCLUDED_dynamic_5fobstacle_5flayer_5fsetting_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_dynamic_5fobstacle_5flayer_5fsetting_2eproto 
...
extern ParaDynamicObstacleLayerDefaultTypeInternal _ParaDynamicObstacleLayer_default_instance_;
}  // namespace roborts_costmap
namespace google {
namespace protobuf {
template<> ::roborts_costmap::ParaDynamicObstacleLayer* Arena::CreateMaybeMessage<::roborts_costmap::ParaDynamicObstacleLayer>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace roborts_costmap {
...
class ParaDynamicObstacleLayer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_costmap.ParaDynamicObstacleLayer) */ {
 public:
  ...
  #if LANG_CXX11
  ParaDynamicObstacleLayer(ParaDynamicObstacleLayer&& from) noexcept
    : ParaDynamicObstacleLayer() {
    *this = ::std::move(from);
  }

  inline ParaDynamicObstacleLayer& operator=(ParaDynamicObstacleLayer&& from) noexcept {
  ...
  static inline const ParaDynamicObstacleLayer* internal_default_instance() {
    return reinterpret_cast<const ParaDynamicObstacleLayer*>(
  ...
  friend void swap(ParaDynamicObstacleLayer& a, ParaDynamicObstacleLayer& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ParaDynamicObstacleLayer* New() const final {
    return CreateMaybeMessage<ParaDynamicObstacleLayer>(NULL);
  }

  ParaDynamicObstacleLayer* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ParaDynamicObstacleLayer>(arena);
  }
 ...
 private:
  void set_has_observation_keep_time();
  void clear_has_observation_keep_time();
  void set_has_expected_update_rate();
  void clear_has_expected_update_rate();
  void set_has_min_obstacle_height();
  void clear_has_min_obstacle_height();
  void set_has_max_obstacle_height();
  void clear_has_max_obstacle_height();
  void set_has_obstacle_range();
  void clear_has_obstacle_range();
  void set_has_raytrace_range();
  void clear_has_raytrace_range();
  void set_has_transform_tolerance();
  void clear_has_transform_tolerance();
  void set_has_topic_string();
  void clear_has_topic_string();
  void set_has_sensor_frame();
  void clear_has_sensor_frame();
  void set_has_obstacle_size();
  void clear_has_obstacle_size();
  void set_has_clearing();
  void clear_has_clearing();
  void set_has_marking();
  void clear_has_marking();
  void set_has_footprint_clearing_enabled();
  void clear_has_footprint_clearing_enabled();
  ...
  bool is_debug_;
  friend struct ::protobuf_dynamic_5fobstacle_5flayer_5fsetting_2eproto::TableStruct;
};
// ===================================================================
...
#if LANG_CXX11
inline void ParaDynamicObstacleLayer::set_topic_string(::std::string&& value) {
  set_has_topic_string();
  topic_string_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:roborts_costmap.ParaDynamicObstacleLayer.topic_string)
}
#endif
...
inline ::std::string* ParaDynamicObstacleLayer::release_topic_string() {
  ...
  clear_has_topic_string();
  return topic_string_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#if LANG_CXX11
inline void ParaDynamicObstacleLayer::set_sensor_frame(::std::string&& value) {
  set_has_sensor_frame();
  sensor_frame_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:roborts_costmap.ParaDynamicObstacleLayer.sensor_frame)
}
#endif
...
inline ::std::string* ParaDynamicObstacleLayer::release_sensor_frame() {
  ...
  clear_has_sensor_frame();
  return sensor_frame_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_dynamic_5fobstacle_5flayer_5fsetting_2eproto
