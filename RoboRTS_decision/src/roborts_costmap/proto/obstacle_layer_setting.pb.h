...
#ifndef PROTOBUF_INCLUDED_obstacle_5flayer_5fsetting_2eproto
#define PROTOBUF_INCLUDED_obstacle_5flayer_5fsetting_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_obstacle_5flayer_5fsetting_2eproto 
...
class ParaObstacleLayer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_costmap.ParaObstacleLayer) */ {
 public:
  ...
  inline ParaObstacleLayer* New() const final {
    return CreateMaybeMessage<ParaObstacleLayer>(NULL);
  }

  ParaObstacleLayer* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  void set_has_inf_is_valid();
  void clear_has_inf_is_valid();
  ...
  bool is_debug_;
  friend struct ::protobuf_obstacle_5flayer_5fsetting_2eproto::TableStruct;
};
// ===================================================================
...
inline void ParaObstacleLayer::set_topic_string(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:roborts_costmap.ParaObstacleLayer.topic_string)
}
#endif
...
inline void ParaObstacleLayer::set_sensor_frame(::std::string&& value) {
  ...
  sensor_frame_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:roborts_costmap.ParaObstacleLayer.sensor_frame)
}
#endif
...
#endif  // PROTOBUF_INCLUDED_obstacle_5flayer_5fsetting_2eproto
